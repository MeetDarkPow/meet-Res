...
\begin{document}
	...
	\begin{minipage}[t]{0.33\textwidth} 
		...
		\href{https://github.com/MeetDarkPow}{\custombold{GitHub \ExternalLink}}:\\
		https://github.com/MeetDarkPow \\
		\href{https://www.linkedin.com/in/meet-bhatnagar-a41842181/}{\custombold{LinkedIn \ExternalLink}}:\\
	...
	\begin{minipage}[t]{0.66\textwidth} 
		...
		\datecolor{MAY-Now, 2021} \runsubsection{\href{https://summerofcode.withgoogle.com/projects/\#5835435529469952}{RCE Explorer, Google Summer of Code \ExternalLink}}
		\descript{Developer}
		\noindent
		\hspace{5em}%
		...
		\datecolor{MAY-JULY, 2019} \runsubsection{\href{https://github.com/MeetDarkPow/Rainfall-Data-Analysis-India-}{R-FLOSS, FOSSEE IIT Bombay \ExternalLink}}
		...
		\datecolor{2020-Now} \runsubsection{\href{https://github.com/MeetDarkPow/R-Community-Analysis}{R Community Explorer - Google Summer of Code \ExternalLink}}
		\descript{}
		\noindent
		\hspace{5em}%
		\begin{minipage}{0.85\textwidth\vspace{2pt}}
		...
		\datecolor{JULY, 2020} \runsubsection{\href{https://www.youtube.com/watch?v=7F7iQdcV8RY&t=2s&ab_channel=RConsortium}{useR! 2020 - The R User International Conference \ExternalLink}}
		\descript{}
		\noindent
		\hspace{5em}%
		\begin{minipage}{0.85\textwidth\vspace{2pt}}
		...
		\section{Publication} 
		\noindent\rule{12.5cm}{0.4pt}
		\datecolor{JUNE, 2020} \runsubsection{\href{https://r.fossee.in/textbook-companion/textbook-run}{Textbook Companion Project \ExternalLink}}
